...
public class DeleteAPI {
		...
		public void startTest() throws InterruptedException{
		  ...
		  /* System.setProperty("webdriver.chrome.driver", "C:/Sel/eclipse-jee-mars-2-win32-x86_64/eclipse/chromedriver.exe");
            ...
            driver.findElement(By.xpath("//html/body/div[2]/div[3]/div/div/div[2]/div/div[1]/div/form/div[1]/div/div/input[1]")).sendKeys("xcxc");                  
          ...
          /* WebDriverWait wait2 = new WebDriverWait(driver, 300);    
           wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(".//*[@class='pull-left brand float-remove-xs text-center-xs']")));
           */
           driver.navigate().to("https://ec2-52-48-105-34.eu-west-1.compute.amazonaws.com:9444/publisher/apis");
